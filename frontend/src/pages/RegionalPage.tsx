                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-base flex items-center gap-2">
                    <span
                      ...
                      style={{
                        backgroundColor:
                          REGION_COLORS[g.region as keyof typeof REGION_COLORS] ?? '#94a3b8',
                      }}
                    />
                    {g.region}
                  </CardTitle>
                  ...
                  <div className="mt-2 space-y-1">
                    {g.frameworks.map((f) => (
                      <div key={f.framework_id} className="flex justify-between text-xs">
                        <span className="text-slate-600 truncate mr-2">{f.framework}</span>
                  ...
                  <tbody>
                    {report.cross_matrix.map((row, i) => (
                      <tr key={i} className="border-b last:border-0">
                        ...
                        <td className="py-3 pr-4 text-slate-600 text-xs max-w-[160px]">
                          {row.eu_requirement}
                        </td>
                        <td className="py-3 pr-4 text-slate-600 text-xs max-w-[160px]">
                          {row.cn_requirement}
