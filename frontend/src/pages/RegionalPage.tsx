    ...
    <PageContainer>
      ...
      {report && (
        <div className="space-y-6">
          <Panel className={`border-l-4 ${readinessBorderClass}`}>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <Panel title={t('regional.dimensionRadar')}>
          ...
          <Panel title={t('regional.crossMatrix')}>
          ...
          {report.compliance_priority.length > 0 && (
            <NoticeBanner tone="warning" title={t('regional.compliancePriority')}>
