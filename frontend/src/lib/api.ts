...
export interface DisclosureFetchRequest {
  ...
  source_hints?: DisclosureSourceHint[]
}

export type DisclosureSourceHint = 'company_site' | 'sec_edgar' | 'hkex' | 'csrc'
...
export interface DisclosureReviewRequest {
  review_note?: string
  include_metrics?: DisclosureMergeMetric[]
}

export type DisclosureMergeMetric =
  | 'scope1_co2e_tonnes'
  | 'scope2_co2e_tonnes'
  | 'scope3_co2e_tonnes'
