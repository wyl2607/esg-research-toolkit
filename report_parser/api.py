...
PROFILE_METRICS = _evidence.PROFILE_METRICS
UPLOAD_FALLBACK_METRICS = _evidence.UPLOAD_FALLBACK_METRICS
_parse_evidence_summary = _evidence._parse_evidence_summary
_normalize_evidence_anchor = _evidence._normalize_evidence_anchor
_evidence_anchors_for_record = _evidence._evidence_anchors_for_record
_manual_evidence_summary = _evidence._manual_evidence_summary
_upload_evidence_summary = _evidence._upload_evidence_summary
_metric_snippet = _evidence._metric_snippet
_metric_anchor_from_record = _evidence._metric_anchor_from_record
_structured_metric_evidence = _evidence._structured_metric_evidence
