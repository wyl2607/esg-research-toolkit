...
# openapi-typescript 7.10 emits unconstrained dict[str, Any] schemas as
# Record<string, never>, which is too narrow for the backend's dynamic payloads.
